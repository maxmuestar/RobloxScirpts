...
local Button = MainTab:CreateButton({
   Name = "tp to begin",
   Callback = function()
   rootPart.CFrame = CFrame.new(468.585846, 511.105164, 997.194275, 0.948438406, 5.22768104e-08, -0.316961527, -1.99628936e-08, 1, 1.05196484e-07, 0.316961527, -9.34449105e-08, 0.948438406)
   end,
})
